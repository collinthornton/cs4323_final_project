...
//   Brief   -   Final Project part4 <extra> driver
//   Date    -   11-30-20
//
// ########################################## 
...
int main(int argc, char **argv) {
    ...
    printf("4th Driver File -> Extra file showing realistic implementation\r\n\r\n");
    ...
    start_sim(num_trainers, num_couches, true, true, true, true);
}